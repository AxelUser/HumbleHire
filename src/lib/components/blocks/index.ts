export { default as ContactsBlock } from './contacts-block.svelte';
export { default as EducationBlock } from './education-block.svelte';
export { default as FullNameBlock } from './full-name-block.svelte';
export { default as HighlightsBlock } from './highlights-block.svelte';
